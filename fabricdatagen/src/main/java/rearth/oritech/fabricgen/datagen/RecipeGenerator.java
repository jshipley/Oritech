...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registries, RecipeExporter exporter) {
        return new RecipeGenerator(registries, exporter) {
            private final RegistryWrapper.WrapperLookup registryLookup = registries.getOrThrow(RegistryKeys.ITEM);
            @Override
            public void generate() {
                ...
                AlloyForgeryRecipeGenerator.generateRecipes(registryLookup, this.withConditions(exporter, new AllModsLoadedResourceCondition(List.of(AlloyForgery.MOD_ID))));
                ClutterRecipeGenerator.generateRecipes(registryLookup, this.withConditions(exporter, new AllModsLoadedResourceCondition(List.of(Clutter.MOD_ID))));
                EnergizedPowerRecipeGenerator.generateRecipes(registryLookup, this.withConditions(exporter, new AllModsLoadedResourceCondition(List.of(EPAPI.MOD_ID))));
                MythicMetalsRecipeGenerator.generateRecipes(registryLookup, this.withConditions(exporter, new AllModsLoadedResourceCondition(List.of(MythicMetals.MOD_ID))));
                TechRebornRecipeGenerator.generateRecipes(registryLookup, this.withConditions(exporter, new AllModsLoadedResourceCondition(List.of(TechReborn.MOD_ID))));
            }
            
            private void addVanillaAdditions(RegistryWrapper.WrapperLookupregistryLookup, RecipeExporter exporter) {
                
                // slimeball from honey and biomass
                AssemblerRecipeBuilder.build(registryLookup).input(Items.HONEYCOMB).input(TagContent.BIOMASS).input(TagContent.BIOMASS).input(TagContent.BIOMASS).result(Items.SLIME_BALL).timeMultiplier(0.8f).export(exporter, "slime");
                // fireball in assembler (gunpowder, blaze powder + coal) = 5 charges
                AssemblerRecipeBuilder.build(registryLookup).input(Items.GUNPOWDER).input(Items.BLAZE_POWDER).input(ItemTags.COALS).input(ItemTags.COALS).result(Items.FIRE_CHARGE, 4).timeMultiplier(0.8f).export(exporter, "fireball");
                // blaze rod (4 powder in assembler)
                AssemblerRecipeBuilder.build(registryLookup).input(Items.BLAZE_POWDER).input(Items.BLAZE_POWDER).input(Items.BLAZE_POWDER).input(Items.BLAZE_POWDER).result(Items.BLAZE_ROD).timeMultiplier(0.8f).export(exporter, "blazerod");
                // enderic compound from sculk
                CentrifugeRecipeBuilder.build(registryLookup).input(Items.SCULK).result(ItemContent.ENDERIC_COMPOUND).timeMultiplier(4f).export(exporter, "endericsculk");
                // budding amethyst (amethyst shard x2, enderic compound, overcharged crystal)
                AssemblerRecipeBuilder.build(registryLookup).input(ConventionalItemTags.AMETHYST_GEMS).input(ConventionalItemTags.AMETHYST_GEMS).input(ItemContent.ENDERIC_COMPOUND).input(ItemContent.OVERCHARGED_CRYSTAL).result(Items.BUDDING_AMETHYST).time(160).export(exporter, "amethystbud");
                // netherite alloying (yes this is pretty OP)
                FoundryRecipeBuilder.build(registryLookup).input(ConventionalItemTags.GOLD_INGOTS).input(Items.NETHERITE_SCRAP).result(Items.NETHERITE_INGOT).export(exporter, "netherite");
                // books
                AssemblerRecipeBuilder.build(registryLookup).input(Items.PAPER).input(Items.PAPER).input(Items.PAPER).input(ConventionalItemTags.LEATHERS).result(Items.BOOK, 2).timeMultiplier(0.8f).export(exporter, "book");
                // reinforced deepslate
                AtomicForgeRecipeBuilder.build(registryLookup).input(Items.DEEPSLATE).input(ItemContent.DURATIUM_INGOT).input(ItemContent.DURATIUM_INGOT).result(Items.REINFORCED_DEEPSLATE).time(100).export(exporter, "reinfdeepslate");
                // cobblestone to gravel
                PulverizerRecipeBuilder.build(registryLookup).input(ConventionalItemTags.COBBLESTONES).result(Items.GRAVEL).addToGrinder().export(exporter, "gravel");
                // gravel to sand
                PulverizerRecipeBuilder.build(registryLookup).input(cItemTag("gravels")).result(Items.SAND).addToGrinder().export(exporter, "sand_from_gravel");
                // sandstone to sand
                PulverizerRecipeBuilder.build(registryLookup).input(ConventionalItemTags.SANDSTONE_BLOCKS).result(Items.SAND).addToGrinder().export(exporter, "sand_from_sandstone");
                // red sandstone to red sand
                PulverizerRecipeBuilder.build(registryLookup).input(ConventionalItemTags.RED_SANDSTONE_BLOCKS).result(Items.RED_SAND).addToGrinder().export(exporter, "red_sand");
                // centrifuge dirt into clay
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemTags.DIRT).result(Items.CLAY).fluidInput(Fluids.WATER, 0.25f).export(exporter, "clay");
                ...
                PulverizerRecipeBuilder.build(registryLookup).input(Items.DRIPSTONE_BLOCK).result(Items.POINTED_DRIPSTONE, 4).addToGrinder().export(exporter, "dripstone");
                // shroomlight from logs and 3 glowstone
                AssemblerRecipeBuilder.build(registryLookup).input(ItemTags.LOGS).input(Items.GLOWSTONE).input(Items.GLOWSTONE).input(Items.GLOWSTONE).result(Items.SHROOMLIGHT).timeMultiplier(0.8f).export(exporter, "shroomlight");
                // recyclables
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_NETHERITE_SCRAP).result(Items.NETHERITE_SCRAP).addToGrinder().export(exporter, "recycle/netherite_scrap");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_DIAMOND).result(Items.DIAMOND).addToGrinder().export(exporter, "recycle/diamond");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_IRON_DUST).result(ItemContent.IRON_DUST).addToGrinder().export(exporter, "recycle/iron_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_SMALL_IRON_DUST).result(ItemContent.SMALL_IRON_DUST).export(exporter, "recycle/small_iron_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_GOLD_DUST).result(ItemContent.GOLD_DUST).export(exporter, "recycle/gold_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_SMALL_GOLD_DUST).result(ItemContent.SMALL_GOLD_DUST).export(exporter, "recycle/small_gold_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_COPPER_DUST).result(ItemContent.COPPER_DUST).export(exporter, "recycle/copper_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_SMALL_COPPER_DUST).result(ItemContent.SMALL_COPPER_DUST).export(exporter, "recycle/small_copper_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_2_QUARTZ_DUST).result(ItemContent.QUARTZ_DUST, 2).export(exporter, "recycle/2_quartz_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_4_QUARTZ_DUST).result(ItemContent.QUARTZ_DUST, 4).export(exporter, "recycle/4_quartz_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_REDSTONE_DUST).result(Items.REDSTONE).export(exporter, "recycle/redstone_dust");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_GRAVEL).result(Items.GRAVEL).export(exporter, "recycle/gravel");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_SAND).result(Items.SAND).export(exporter, "recycle/sand");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_RED_SAND).result(Items.RED_SAND).export(exporter, "recycle/red_sand");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_STRING).result(Items.STRING, 3).export(exporter, "recycle/string");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RECYCLES_TO_BIOMASS).result(ItemContent.BIOMASS).export(exporter, "recycle/biomass");
            }
            
            private void addDyes(RecipeExporter exporter) {
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_WHITE_DYE).result(Items.WHITE_DYE).addToGrinder().export(exporter, "dyes/white");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_LIGHT_GRAY_DYE).result(Items.LIGHT_GRAY_DYE).addToGrinder().export(exporter, "dyes/light_gray");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_BLACK_DYE).result(Items.BLACK_DYE).addToGrinder().export(exporter, "dyes/black");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_RED_DYE).result(Items.RED_DYE).addToGrinder().export(exporter, "dyes/red");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_ORANGE_DYE).result(Items.ORANGE_DYE).addToGrinder().export(exporter, "dyes/orange");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_YELLOW_DYE).result(Items.YELLOW_DYE).addToGrinder().export(exporter, "dyes/yellow");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_CYAN_DYE).result(Items.CYAN_DYE).addToGrinder().export(exporter, "dyes/cyan");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_BLUE_DYE).result(Items.BLUE_DYE).addToGrinder().export(exporter, "dyes/blue");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_MAGENTA_DYE).result(Items.MAGENTA_DYE).addToGrinder().export(exporter, "dyes/magenta");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.RAW_PINK_DYE).result(Items.PINK_DYE).addToGrinder().export(exporter, "dyes/pink");
            }
            
            private void addDeepDrillOres(RecipeExporter exporter) {
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_REDSTONE).result(Items.REDSTONE).export(exporter, "redstone");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_LAPIS).result(Items.LAPIS_LAZULI).export(exporter, "lapis");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_IRON).result(Items.RAW_IRON).export(exporter, "iron");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_COAL).result(Items.COAL).export(exporter, "coal");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_COPPER).result(Items.RAW_COPPER).export(exporter, "copper");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_GOLD).result(Items.RAW_GOLD).export(exporter, "gold");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_EMERALD).result(Items.EMERALD).export(exporter, "emerald");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_DIAMOND).result(Items.DIAMOND).export(exporter, "diamond");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_NICKEL).result(ItemContent.RAW_NICKEL).export(exporter, "nickel");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_PLATINUM).result(ItemContent.RAW_PLATINUM).export(exporter, "platinum");
                DeepDrillRecipeBuilder.build(registryLookup).input(BlockContent.RESOURCE_NODE_URANIUM).result(ItemContent.RAW_URANIUM).export(exporter, "uranium");
            }
            
            private void addFuels(RecipeExporter exporter) {
                
                // bio
                BioGeneratorRecipeBuilder.build(registryLookup).input(TagContent.BIOMATTER).timeInSeconds(15).export(exporter, "rawbio");
                BioGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.PACKED_WHEAT).timeInSeconds(200).export(exporter, "packedwheat");
                BioGeneratorRecipeBuilder.build(registryLookup).input(TagContent.BIOMASS).timeInSeconds(25).export(exporter, "biomass");
                BioGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.SOLID_BIOFUEL).timeInSeconds(160).export(exporter, "solidbiomass");
                BioGeneratorRecipeBuilder.build(registryLookup).input(TagContent.BIOMASS_BLOCK).timeInSeconds(270).export(exporter, "biomassblock");
                BioGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.RAW_BIOPOLYMER).timeInSeconds(300).export(exporter, "polymer");
                BioGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.UNHOLY_INTELLIGENCE).timeInSeconds(3000).export(exporter, "vex");
                // lava
                LavaGeneratorRecipeBuilder.build(registryLookup).fluidInput(Fluids.LAVA, 0.1f).timeInSeconds(12).export(exporter, "lava");
                // fuel
                FuelGeneratorRecipeBuilder.build(registryLookup).fluidInput(FluidContent.STILL_OIL.get(), 0.1f).timeInSeconds(3).export(exporter, "crude");
                FuelGeneratorRecipeBuilder.build(registryLookup).fluidInput(FluidContent.STILL_FUEL.get(), 0.1f).timeInSeconds(12).export(exporter, "fuel");
                //steam
                SteamGeneratorRecipeBuilder.build(registryLookup).fluidInput(FluidStack.create(FluidContent.STILL_STEAM.get(), 32)).time(1).export(exporter, "steameng");
            }
            
            private void addBiomass(RecipeExporter exporter) {
                // biomass
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.BIOMATTER).result(ItemContent.BIOMASS).addToGrinder().export(exporter, "biobasic");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemContent.PACKED_WHEAT).result(ItemContent.BIOMASS, 16).addToGrinder().export(exporter, "packagedwheatbio");
                PulverizerRecipeBuilder.build(registryLookup).input(cItemTag("storage_blocks/wheat")).result(ItemContent.BIOMASS, 16).addToGrinder().export(exporter, "hay_block");
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.BIOMASS).input(TagContent.BIOMASS).input(TagContent.BIOMASS).input(ItemTags.PLANKS).result(ItemContent.SOLID_BIOFUEL).timeMultiplier(0.8f).export(exporter, "solidbiofuel");
            }
            ...
            private void addComponents(RecipeExporter exporter) {
                ...
                CentrifugeRecipeBuilder.build(registryLookup).input(TagContent.COAL_DUSTS).result(ItemContent.CARBON_FIBRE_STRANDS).timeMultiplier(0.5f).export(exporter, "carbon");
                ...
                // enderic entry
                PulverizerRecipeBuilder.build(registryLookup).input(ConventionalItemTags.ENDER_PEARLS).result(ItemContent.ENDERIC_COMPOUND, 8).export(exporter, "pearl_enderic");
                GrinderRecipeBuilder.build(registryLookup).input(ConventionalItemTags.ENDER_PEARLS).result(ItemContent.ENDERIC_COMPOUND, 12).export(exporter, "pearl_enderic");
                GrinderRecipeBuilder.build(registryLookup).input(Blocks.END_STONE).result(ItemContent.ENDERIC_COMPOUND).export(exporter, "stone_enderic");
                
                // fine wires
                offerCableRecipe(exporter, new ItemStack(ItemContent.INSULATED_WIRE, 4), of(TagContent.NICKEL_INGOTS), "insulatedwire");
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.NICKEL_INGOTS).input(TagContent.NICKEL_INGOTS).input(TagContent.NICKEL_INGOTS).input(ConventionalItemTags.COPPER_INGOTS).result(ItemContent.INSULATED_WIRE, 12).timeMultiplier(0.4f).export(exporter, "fwire");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.STEEL_INGOTS).input(TagContent.WIRES).input(TagContent.WIRES).input(TagContent.WIRES).result(ItemContent.MAGNETIC_COIL, 2).timeMultiplier(0.4f).export(exporter, "magnet");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.NICKEL_INGOTS).input(TagContent.STEEL_INGOTS).input(ItemContent.MAGNETIC_COIL).input(ItemContent.MAGNETIC_COIL).result(ItemContent.MOTOR, 2).timeMultiplier(0.4f).export(exporter, "motor");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.STEEL_INGOTS).input(TagContent.STEEL_INGOTS).input(ConventionalItemTags.COPPER_INGOTS).input(TagContent.PLASTIC_PLATES).result(BlockContent.MACHINE_PLATING_BLOCK.asItem(), 8).timeMultiplier(0.8f).export(exporter, "plating");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.STEEL_INGOTS).input(TagContent.STEEL_INGOTS).input(ConventionalItemTags.IRON_INGOTS).input(TagContent.PLASTIC_PLATES).result(BlockContent.IRON_PLATING_BLOCK.asItem(), 8).timeMultiplier(0.8f).export(exporter, "platingiron");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.STEEL_INGOTS).input(TagContent.STEEL_INGOTS).input(TagContent.NICKEL_INGOTS).input(TagContent.PLASTIC_PLATES).result(BlockContent.NICKEL_PLATING_BLOCK.asItem(), 8).timeMultiplier(0.8f).export(exporter, "platingnickel");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.PLASTIC_PLATES).input(TagContent.ELECTRUM_INGOTS).input(TagContent.ELECTRUM_INGOTS).input(TagContent.STEEL_INGOTS).result(ItemContent.BASIC_BATTERY).timeMultiplier(0.4f).export(exporter, "battery");
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.PLASTIC_PLATES).input(ItemContent.FLUXITE).input(ItemContent.FLUXITE).input(TagContent.STEEL_INGOTS).result(ItemContent.BASIC_BATTERY, 2).timeMultiplier(0.8f).export(exporter, "batterybetter");
                ...
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.PACKED_WHEAT).result(ItemContent.RAW_BIOPOLYMER).fluidInput(Fluids.WATER, 0.25f).export(exporter, "biopolymer");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.SOLID_BIOFUEL).result(ItemContent.RAW_BIOPOLYMER).fluidInput(Fluids.WATER, 0.25f).export(exporter, "biopolymer_biomass");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(TagContent.BIOMASS_BLOCK).result(ItemContent.RAW_BIOPOLYMER).fluidInput(Fluids.WATER, 0.25f).export(exporter, "biopolymer_bioblock");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemTags.SAND).result(ItemContent.POLYMER_RESIN).fluidInput(FluidContent.STILL_OIL.get(), 0.1f).time(100).export(exporter, "polymerresin");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.RAW_BIOPOLYMER).result(ItemContent.PLASTIC_SHEET).fluidInput(Fluids.WATER, 0.5f).export(exporter, "plasticoil");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.POLYMER_RESIN).result(ItemContent.PLASTIC_SHEET).fluidInput(Fluids.WATER, 0.5f).time(66).export(exporter, "plasticbio");
                
                // processing unit
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.PLASTIC_PLATES).input(TagContent.CARBON_FIBRE).input(TagContent.ELECTRUM_INGOTS).input(ConventionalItemTags.REDSTONE_DUSTS).result(ItemContent.PROCESSING_UNIT).timeMultiplier(0.8f).export(exporter, "processingunit");
                // enderic lens
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.ADAMANT_INGOT).input(TagContent.CARBON_FIBRE).input(ItemContent.ENDERIC_COMPOUND).input(ItemContent.ENDERIC_COMPOUND).result(ItemContent.ENDERIC_LENS).timeMultiplier(1.2f).export(exporter, "enderlens");
                // flux gate
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.PROCESSING_UNIT).input(ItemContent.FLUXITE).input(ItemContent.FLUXITE).input(TagContent.PLATINUM_INGOTS).result(ItemContent.FLUX_GATE).timeMultiplier(1.2f).export(exporter, "fluxgate");
                
                // ai processor tree
                AtomicForgeRecipeBuilder.build(registryLookup).input(TagContent.CARBON_FIBRE).input(TagContent.SILICON).input(TagContent.SILICON).result(ItemContent.SILICON_WAFER).time(5).export(exporter, "wafer");
                AtomicForgeRecipeBuilder.build(registryLookup).input(ItemContent.PROCESSING_UNIT).input(ItemContent.SILICON_WAFER).input(ItemContent.SILICON_WAFER).result(ItemContent.ADVANCED_COMPUTING_ENGINE).time(5).export(exporter, "advcomputer");
                AtomicForgeRecipeBuilder.build(registryLookup).input(ItemContent.DURATIUM_INGOT).input(ItemContent.ADVANCED_COMPUTING_ENGINE).input(ItemContent.ADVANCED_COMPUTING_ENGINE).result(ItemContent.SUPER_AI_CHIP).time(50).export(exporter, "aicomputer");
                ...
                // fuel
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.FLUXITE).fluidInput(FluidContent.STILL_OIL.get()).fluidOutput(FluidContent.STILL_FUEL.get()).export(exporter, "fuel");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(ItemContent.FLUXITE).fluidInput(FluidContent.STILL_BIOFUEL.get()).fluidOutput(FluidContent.STILL_FUEL.get()).export(exporter, "fuel_from_biofuel");
                CentrifugeFluidRecipeBuilder.build(registryLookup).input(TagContent.BIOMASS).fluidInput(Fluids.WATER, 0.25f).fluidOutput(FluidContent.STILL_BIOFUEL.get(), 0.1f).timeMultiplier(0.2f).export(exporter, "biofuel");
                
                // biosteel
                FoundryRecipeBuilder.build(registryLookup).input(ItemContent.RAW_BIOPOLYMER).input(ConventionalItemTags.IRON_INGOTS).result(ItemContent.BIOSTEEL_INGOT).export(exporter, "biosteel");
                
                // endgame components
                AtomicForgeRecipeBuilder.build(registryLookup).input(ItemContent.SUPER_AI_CHIP).input(ItemContent.ADAMANT_INGOT).input(ItemContent.ADAMANT_INGOT).result(ItemContent.HEISENBERG_COMPENSATOR).time(60).export(exporter, "compensator");
                AtomicForgeRecipeBuilder.build(registryLookup).input(ItemContent.UNHOLY_INTELLIGENCE).input(ItemContent.ADAMANT_INGOT).input(ItemContent.ADAMANT_INGOT).result(ItemContent.HEISENBERG_COMPENSATOR).time(60).export(exporter, "compensatoralt");
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.FLUX_GATE).input(TagContent.WIRES).input(ItemContent.DUBIOS_CONTAINER).input(ItemContent.ENERGITE_INGOT).result(BlockContent.SUPERCONDUCTOR.asItem(), 3).timeMultiplier(1.6f).export(exporter, "superconductor");
                AtomicForgeRecipeBuilder.build(registryLookup).input(ItemContent.HEISENBERG_COMPENSATOR).input(ItemContent.OVERCHARGED_CRYSTAL).input(ItemContent.OVERCHARGED_CRYSTAL).result(ItemContent.PROMETHEUM_INGOT).time(240).export(exporter, "prometheum");
                
                // ice in cooler
                CoolerRecipeBuilder.build(registryLookup).fluidInput(Fluids.WATER).result(Items.ICE, 3).export(exporter, "ice");
                
                // snow from steam in cooler
                CoolerRecipeBuilder.build(registryLookup).fluidInput(FluidContent.STILL_STEAM.get()).result(Items.SNOW_BLOCK, 3).export(exporter, "snow");

                // obsidian from lava
                CoolerRecipeBuilder.build(registryLookup).fluidInput(Fluids.LAVA).result(Items.OBSIDIAN, 2).export(exporter, "obsidian");        
            }
            ...
            private void addOreChains(RecipeExporter exporter) {
                ...
                // iron chain
                MetalProcessingChainBuilder.build(registryLookup, "iron")
                    ...
                    .export(exporter);
                // copper chain
                MetalProcessingChainBuilder.build(registryLookup, "copper")
                    ...
                    .export(exporter);
                // gold chain
                MetalProcessingChainBuilder.build(registryLookup, "gold")
                    ...
                    .export(exporter);
                // nickel chain
                MetalProcessingChainBuilder.build(registryLookup, "nickel")
                    ...
                    .export(exporter);
                // platinum chain
                MetalProcessingChainBuilder.build(registryLookup, "platinum")
            ...
            private void addAlloys(RecipeExporter exporter) {
                FoundryRecipeBuilder.build(registryLookup).input(TagContent.PLATINUM_INGOTS).input(ConventionalItemTags.NETHERITE_INGOTS).result(ItemContent.DURATIUM_INGOT).export(exporter, "duratium");
                FoundryRecipeBuilder.build(registryLookup).input(ConventionalItemTags.GOLD_INGOTS).input(ConventionalItemTags.REDSTONE_DUSTS).result(ItemContent.ELECTRUM_INGOT).export(exporter, "electrum");
                FoundryRecipeBuilder.build(registryLookup).input(ConventionalItemTags.DIAMOND_GEMS).input(TagContent.NICKEL_INGOTS).result(ItemContent.ADAMANT_INGOT).export(exporter, "adamant");
                FoundryRecipeBuilder.build(registryLookup).input(TagContent.NICKEL_INGOTS).input(ItemContent.FLUXITE).result(ItemContent.ENERGITE_INGOT).export(exporter, "energite");
                FoundryRecipeBuilder.build(registryLookup).input(ConventionalItemTags.IRON_INGOTS).input(TagContent.COAL_DUSTS).result(ItemContent.STEEL_INGOT).timeMultiplier(0.3333f).export(exporter, "steel");
            }
            
            private void addParticleCollisions(RecipeExporter exporter) {
                // diamond from coal dust
                ParticleCollisionRecipeBuilder.build(registryLookup).input(TagContent.COAL_DUSTS).input(TagContent.COAL_DUSTS).result(Items.DIAMOND).time(500).export(exporter, "diamond");
                // overcharged crystal from fluxite and energite dust
                ParticleCollisionRecipeBuilder.build(registryLookup).input(ItemContent.FLUXITE).input(ItemContent.ENERGITE_DUST).result(ItemContent.OVERCHARGED_CRYSTAL).time(5000).export(exporter, "overcharged_crystal");
                // platinum from gold dust
                ParticleCollisionRecipeBuilder.build(registryLookup).input(TagContent.GOLD_DUSTS).input(TagContent.GOLD_DUSTS).result(ItemContent.PLATINUM_DUST).time(500).export(exporter, "platinum_dust");
                // enderic compound from redstone and flesh
                ParticleCollisionRecipeBuilder.build(registryLookup).input(ConventionalItemTags.REDSTONE_DUSTS).input(Items.ROTTEN_FLESH).result(ItemContent.ENDERIC_COMPOUND).time(500).export(exporter, "enderic_compound");
                // fluxite from electrum dust and redstone
                ParticleCollisionRecipeBuilder.build(registryLookup).input(TagContent.ELECTRUM_DUSTS).input(ConventionalItemTags.REDSTONE_DUSTS).result(ItemContent.FLUXITE).time(1000).export(exporter, "fluxite");
                // netherite scrap from adamant dust and netherrack
                ParticleCollisionRecipeBuilder.build(registryLookup).input(ItemContent.ADAMANT_DUST).input(Items.NETHERRACK).result(Items.NETHERITE_SCRAP).time(2500).export(exporter, "netherite");
                // elytra from feather and saddle
                ParticleCollisionRecipeBuilder.build(registryLookup).input(cItemTag("feathers")).input(Items.SADDLE).result(Items.ELYTRA).time(10000).export(exporter, "elytra");
                // nether star from overcharged crystal and netherite
                ParticleCollisionRecipeBuilder.build(registryLookup).input(ItemContent.OVERCHARGED_CRYSTAL).input(ConventionalItemTags.NETHERITE_INGOTS).result(Items.NETHER_STAR).time(15000).export(exporter, "nether_star");
                // echo shard from ender pearl and amethyst shard
                ParticleCollisionRecipeBuilder.build(registryLookup).input(ConventionalItemTags.ENDER_PEARLS).input(ConventionalItemTags.AMETHYST_GEMS).result(Items.ECHO_SHARD).time(1000).export(exporter, "echo_shard");
                // heavy core from reinforced deepslate block and duration dust
                ParticleCollisionRecipeBuilder.build(registryLookup).input(Items.REINFORCED_DEEPSLATE).input(ItemContent.DURATIUM_DUST).result(Items.HEAVY_CORE).time(8000).export(exporter, "heavy_core");
            }
            ...
            private void addDusts(RecipeExporter exporter) {
                ...
                // coal
                GrinderRecipeBuilder.build(registryLookup).input(ItemTags.COAL_ORES).result(Items.COAL, 3).export(exporter, "coalore");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemTags.COAL_ORES).result(Items.COAL, 2).export(exporter, "coalore");
                // redstone
                GrinderRecipeBuilder.build(registryLookup).input(ItemTags.REDSTONE_ORES).result(Items.REDSTONE, 12).export(exporter, "redstoneore");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemTags.REDSTONE_ORES).result(Items.REDSTONE, 8).export(exporter, "redstoneore");
                // diamond
                GrinderRecipeBuilder.build(registryLookup).input(ItemTags.DIAMOND_ORES).result(Items.DIAMOND, 2).export(exporter, "diamondore");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemTags.DIAMOND_ORES).result(Items.DIAMOND).export(exporter, "diamondore");
                // quartz
                GrinderRecipeBuilder.build(registryLookup).input(Blocks.NETHER_QUARTZ_ORE).result(Items.QUARTZ, 3).export(exporter, "quartzore");
                PulverizerRecipeBuilder.build(registryLookup).input(Blocks.NETHER_QUARTZ_ORE).result(Items.QUARTZ, 2).export(exporter, "quartzore");
                // glowstone
                GrinderRecipeBuilder.build(registryLookup).input(Blocks.GLOWSTONE).result(Items.GLOWSTONE_DUST, 4).export(exporter, "glowstoneore");
                PulverizerRecipeBuilder.build(registryLookup).input(Blocks.GLOWSTONE).result(Items.GLOWSTONE_DUST, 3).export(exporter, "glowstoneore");
                // lapis
                GrinderRecipeBuilder.build(registryLookup).input(ItemTags.LAPIS_ORES).result(Items.LAPIS_LAZULI, 8).export(exporter, "lapisore");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemTags.LAPIS_ORES).result(Items.LAPIS_LAZULI, 6).export(exporter, "lapisore");
                // bone
                GrinderRecipeBuilder.build(registryLookup).input(Items.BONE).result(Items.BONE_MEAL, 8).export(exporter, "bone");
                PulverizerRecipeBuilder.build(registryLookup).input(Items.BONE).result(Items.BONE_MEAL, 6).export(exporter, "bone");
                // blaze powder
                GrinderRecipeBuilder.build(registryLookup).input(Items.BLAZE_ROD).result(Items.BLAZE_POWDER, 4).export(exporter, "blaze");
                PulverizerRecipeBuilder.build(registryLookup).input(Items.BLAZE_ROD).result(Items.BLAZE_POWDER, 3).export(exporter, "blaze");
                // wool
                GrinderRecipeBuilder.build(registryLookup).input(ItemTags.WOOL).result(Items.STRING, 4).export(exporter, "string");
                PulverizerRecipeBuilder.build(registryLookup).input(ItemTags.WOOL).result(Items.STRING, 3).export(exporter, "string");
                // ancient debris
                GrinderRecipeBuilder.build(registryLookup).input(Items.ANCIENT_DEBRIS).result(Items.NETHERITE_SCRAP, 2).export(exporter, "netheritescrap");
            }
            ...
            private void addUraniumProcessing(RecipeExporter exporter) {
                ...
                CentrifugeRecipeBuilder.build(registryLookup).input(ConventionalItemTags.REDSTONE_DUSTS).result(ItemContent.SMALL_URANIUM_DUST).export(exporter, "redstoneuran");
                
                // uranium ore blocks
                GrinderRecipeBuilder.build(registryLookup).input(BlockContent.DEEPSLATE_URANIUM_ORE).result(ItemContent.RAW_URANIUM, 3).result(ItemContent.SMALL_PLUTONIUM_DUST).export(exporter, "uraniumore");
                PulverizerRecipeBuilder.build(registryLookup).input(BlockContent.DEEPSLATE_URANIUM_ORE).result(ItemContent.RAW_URANIUM, 2).export(exporter, "uraniumore");
                
                // uranium crystal blocks
                GrinderRecipeBuilder.build(registryLookup).input(BlockContent.URANIUM_CRYSTAL).result(ItemContent.RAW_URANIUM, 5).result(ItemContent.SMALL_PLUTONIUM_DUST).export(exporter, "uraniumcrystal");
                PulverizerRecipeBuilder.build(registryLookup).input(BlockContent.URANIUM_CRYSTAL).result(ItemContent.RAW_URANIUM, 4).export(exporter, "uraniumcrystal");
                
                // raw uranium in grinder
                GrinderRecipeBuilder.build(registryLookup).input(TagContent.URANIUM_RAW_MATERIALS).result(ItemContent.URANIUM_DUST, 2).result(ItemContent.SMALL_PLUTONIUM_DUST).export(exporter, "uranium");
                PulverizerRecipeBuilder.build(registryLookup).input(TagContent.URANIUM_RAW_MATERIALS).result(ItemContent.URANIUM_DUST, 2).export(exporter, "uranium");
                
                // uranium gem from raw uranium / uranium dust in atomic forge
                AtomicForgeRecipeBuilder.build(registryLookup).input(TagContent.COPPER_DUSTS).input(TagContent.URANIUM_RAW_MATERIALS).input(TagContent.URANIUM_RAW_MATERIALS).result(ItemContent.URANIUM_GEM).time(5).export(exporter, "urandust");
                AtomicForgeRecipeBuilder.build(registryLookup).input(TagContent.COPPER_DUSTS).input(TagContent.URANIUM_DUSTS).input(TagContent.URANIUM_DUSTS).result(ItemContent.URANIUM_GEM).time(5).export(exporter, "urandustgem");
                
                // uranium pellets in assembler
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.URANIUM_GEM).input(ItemContent.URANIUM_GEM).input(TagContent.PLASTIC_PLATES).input(TagContent.NICKEL_INGOTS).result(ItemContent.URANIUM_PELLET, 2).timeMultiplier(0.8f).export(exporter, "uranpelletbasic");
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.URANIUM_GEM).input(ItemContent.URANIUM_GEM).input(TagContent.PLASTIC_PLATES).input(ItemContent.ADAMANT_INGOT).result(ItemContent.URANIUM_PELLET, 3).timeMultiplier(0.8f).export(exporter, "uranpelletbetter");
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.URANIUM_GEM).input(ItemContent.URANIUM_GEM).input(TagContent.PLASTIC_PLATES).input(ItemContent.DURATIUM_INGOT).result(ItemContent.URANIUM_PELLET, 4).timeMultiplier(0.8f).export(exporter, "uranpelletult");
                
                // plutonium pellets in assembler
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.PLUTONIUM_DUST).input(ItemContent.PLUTONIUM_DUST).input(TagContent.PLASTIC_PLATES).input(TagContent.NICKEL_INGOTS).result(ItemContent.PLUTONIUM_PELLET, 2).timeMultiplier(0.8f).export(exporter, "plutoniumpelletbasic");
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.PLUTONIUM_DUST).input(ItemContent.PLUTONIUM_DUST).input(TagContent.PLASTIC_PLATES).input(ItemContent.ADAMANT_INGOT).result(ItemContent.PLUTONIUM_PELLET, 3).timeMultiplier(0.8f).export(exporter, "plutoniumpelletbetter");
                AssemblerRecipeBuilder.build(registryLookup).input(ItemContent.PLUTONIUM_DUST).input(ItemContent.PLUTONIUM_DUST).input(TagContent.PLASTIC_PLATES).input(ItemContent.DURATIUM_INGOT).result(ItemContent.PLUTONIUM_PELLET, 4).timeMultiplier(0.8f).export(exporter, "plutoniumpelletult");
                ...
                ParticleCollisionRecipeBuilder.build(registryLookup).input(TagContent.URANIUM_DUSTS).input(ItemContent.FLUXITE).result(ItemContent.PLUTONIUM_DUST).time(2500).export(exporter, "plutonium");
            ...
            private void addAugmentRecipes(RecipeExporter exporter) {
                ...
                AugmentRecipeBuilder.build(registries.getOrThrow(RegistryKeys.ITEM))
                ...
                AugmentRecipeBuilder.build(registryLookup)
            ...
            private void addReactorBlocks(RecipeExporter exporter) {
                ...
                AssemblerRecipeBuilder.build(registryLookup).input(TagContent.MACHINE_PLATING).input(TagContent.MACHINE_PLATING).input(TagContent.STEEL_INGOTS).input(TagContent.NICKEL_INGOTS).result(BlockContent.REACTOR_WALL.asItem(), 3).timeMultiplier(0.8f).export(exporter, "reactorplatingalt");
            ...
            private void addReactorFuels(RecipeExporter exporter) {
                ReactorGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.SMALL_URANIUM_PELLET).time(400).export(exporter, "smallpellet");
                ReactorGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.URANIUM_PELLET).time(4000).export(exporter, "pellet");
                ReactorGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.SMALL_PLUTONIUM_PELLET).time(4000).export(exporter, "smallplutoniumpellet");
                ReactorGeneratorRecipeBuilder.build(registryLookup).input(ItemContent.PLUTONIUM_PELLET).time(40000).export(exporter, "plutoniumpellet");
            }
            
            private void addLaserTransformations(RecipeExporter exporter) {
                LaserRecipeBuilder.build(registryLookup).input(Items.AMETHYST_CLUSTER).result(ItemContent.FLUXITE).export(exporter, "fluxite");
                LaserRecipeBuilder.build(registryLookup).input(BlockContent.URANIUM_CRYSTAL).result(ItemContent.PLUTONIUM_DUST).export(exporter, "plutoniumdust");
            }
            ...
            private void addCompactingRecipe(RecipeExporter exporter, ItemConvertible resBlock, ItemConvertible resItem, Ingredient itemIng, Ingredient blockIng) {
                ...
                .create(registryLookup, RecipeCategory.MISC, resItem, 9)
                .input(blockIng)
                ...
                .create(registryLookup, RecipeCategory.MISC, resBlock)
                .input('#', itemIng)
                .pattern("###")
                .pattern("###")
                .pattern("###")
